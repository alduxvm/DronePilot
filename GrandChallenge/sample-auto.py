...
""" sample-auto.py -> UAS Grand Challenge mission (autonomous sample mission to pass scrutiny) to do WP's. """
...
samplewp1 = Location(52.486168, -1.143092, cruise_altitude, is_relative=True)
samplewp2 = Location(52.486641, -1.141860, cruise_altitude, is_relative=True)
